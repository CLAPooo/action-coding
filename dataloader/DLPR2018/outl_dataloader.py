...
class outl_dataset(Dataset):  
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            clips = []
            clips.append(random.randint(1, 1))
            clips.append(random.randint(1, 1))
            clips.append(random.randint(1, 1))
            #print clips
        elif self.mode == 'val':
...
class outl_dataloader():
    ...
    def train(self):
        training_set = outl_dataset(dic=self.dic_training, root_dir=self.data_path, mode='train', transform = transforms.Compose([
    ...
    def validate(self):
        validation_set = outl_dataset(dic=self.dic_testing, root_dir=self.data_path, mode='val', transform = transforms.Compose([
...
if __name__ == '__main__':
    ...
    dataloader = outl_dataloader(BATCH_SIZE=1, num_workers=1, 
                                path='/home/chao/chao/action/pytorch/3D-ResNets-PyTorch/utils/5_con/', 
